...
import { Orbit, Zap, Users, Lock, ArrowRight, Check } from 'lucide-react';

const products = [
  {
    name: "Orbit Platform",
    description: "Enterprise management solution for seamless business operations",
    features: [
  ...
  {
    name: "Nova Analytics",
    description: "Advanced data analytics platform powered by AI",
    features: [
